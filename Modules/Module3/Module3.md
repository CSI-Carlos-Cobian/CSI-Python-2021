...
What is the difference between "42" and 42.
 ...
 - Answer: first is a spring and the other is an intenger

Define the boolean operators: >, <, ==, >=, <=

 - Answer:>:grester than <: less than ==:equals >=: more or equal than <=:less or equal than
